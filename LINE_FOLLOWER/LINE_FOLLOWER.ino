...
#define enA 10;
#define enB 5;
#define RIGHT_SENSOR 12=0;
#define LEFT_SENSOR 11=0;
 ...
 void setup() {
  ...
  pinMode(in4,OUTPUT);
    ...
    pinMode(enB,OUTPUT);
      ...
      pinMode(11, INPUT); // initialize Left sensor as an input
      pinMode(12, INPUT); // initialize Right sensor as an input
      Serial.begin(9600);
}
